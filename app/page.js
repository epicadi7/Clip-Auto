    ...
    >
      ...
      >
        <div style={{ fontWeight: 800, fontSize: '18px', letterSpacing: '1px' }}>
          CLIP<span style={{ color: '#e8722c' }}>AUTO</span>
        </div>
        <div style={{ display: 'flex', gap: '28px', fontSize: '14px', color: '#9a9fa6' }}>
          <span>Home</span>
          <span>Features</span>
      ...
      {/* GRADIENT BLOB SHAPE - top right, original abstract SVG */}
      <svg
        width="600"
        height="600"
        viewBox="0 0 600 600"
        style={{ position: 'absolute', top: '-100px', right: '-150px', zIndex: 1, opacity: 0.85 }}
      >
        <defs>
          <linearGradient id="blobGrad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#e8722c" />
            <stop offset="100%" stopColor="#c2451a" />
          </linearGradient>
        </defs>
        <path
          d="M420,60 C480,120 520,200 480,280 C440,360 340,380 300,440 C260,500 220,560 160,540 C100,520 80,440 120,380 C160,320 240,300 280,240 C320,180 360,0 420,60 Z"
          fill="url(#blobGrad)"
        />
      </svg>

      <div style={{ position: 'relative', zIndex: 2, display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '40px 20px 80px' }}>
        {/* HERO */}
        <h1 style={{ fontSize: '60px', fontWeight: 800, lineHeight: 1.1, textAlign: 'center', marginTop: '40px' }}>
          MAKE THE
          <br />
          ...
          <svg width="100%" height="160" viewBox="0 0 280 160" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="thumbGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <stop offset="100%" stopColor="#212327" />
              </linearGradient>
            </defs>
            ...
            <path d="M133 68 L133 92 L155 80 Z" fill="#0a0a0b" />
          </svg>
          <span
            style={{
              position: 'absolute',
          ...
          <div style={{ display: 'flex', gap: '16px', overflowX: 'auto', paddingBottom: '10px' }}>
            {sampleClips.map((clip, i) => (
              ...
              >
                ...
                <div style={{ padding: '8px', backgroundColor: '#0f1012', textAlign: 'center' }}>
                  <span
                    style={{
                      fontSize: '13px',
                      fontWeight: 700,
